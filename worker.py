# worker.py - Multi API Failover Edition
import os
import sys
import zipfile
import shutil
...
async def main():
    ...
    await update_status("⏳ **Worker Initialized:** Downloading...")
    ...
    if len(pages) == 0:
        ...
        return await bot.stop()
    await update_status(f"🔄 **AI Engine Started:** {len(pages)} panels | {LANG}\n⚡ Trying Groq -> Gemini -> DeepL...")
